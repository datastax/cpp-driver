      ...
      case DSE_GRAPH_RESULT_TYPE_OBJECT:
        ...
        for (size_t i = 0; i < member_count(); ++i) {
          output << std::endl
            ...
            << ":";
          DseGraphResult member(member(i));
