...
The [`CassResult`](http://docs.datastax.com/en/developer/cpp-driver/latest/api/struct.CassResult/) object
...
using a [`CassIterator`](http://docs.datastax.com/en/developer/cpp-driver/latest/api/struct.CassIterator/)
...
Once the [`CassValue`](http://docs.datastax.com/en/developer/cpp-driver/latest/api/struct.CassValue/)
...
[`CassResult`](http://docs.datastax.com/en/developer/cpp-driver/latest/api/struct.CassResult/) object
...
[`cass_statement_set_paging_state()`]: http://docs.datastax.com/en/developer/cpp-driver/latest/api/struct.CassStatement/#cass-statement-set-paging-state
[`cass_result_paging_state()`]: http://docs.datastax.com/en/developer/cpp-driver/latest/api/struct.CassResult/#cass-result-paging-state
[`cass_statement_set_paging_state_token()`]: http://docs.datastax.com/en/developer/cpp-driver/latest/api/struct.CassStatement/#cass-statement-set-paging-state-token
