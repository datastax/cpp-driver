...
```
[`cass_uuid_timestamp()`]: http://docs.datastax.com/en/developer/cpp-driver/latest/api/struct.CassUuid/#1a3980467a0bb6642054ecf37d49aebf1a
[`CassUuidGen`]: http://docs.datastax.com/en/developer/cpp-driver/latest/api/struct.CassUuidGen/
