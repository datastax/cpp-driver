...
BOOST_AUTO_TEST_CASE(empty_credentials)
{
  ...
  invalid_credentials(3, "user", NULL, expected_error, CASS_ERROR_LIB_NO_HOSTS_AVAILABLE);
  invalid_credentials(4, NULL, "pass", expected_error, CASS_ERROR_LIB_NO_HOSTS_AVAILABLE);
  invalid_credentials(4, "user", NULL, expected_error, CASS_ERROR_LIB_NO_HOSTS_AVAILABLE);
}
