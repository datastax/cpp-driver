...
if(NOT OPENSSL_VERSION)
  # TODO: Should we default to OpenSSL 1.1 (e.g. 1.1.0h)?
...
file(WRITE ${OPENSSL_MAKE_SCRIPT}
  ...
  "POPD\r\n")
if(OPENSSL_MAJOR_MINOR_VERSION STREQUAL "1.0")
  file(APPEND ${OPENSSL_MAKE_SCRIPT} "NMake /F \"${OPENSSL_1_0_MAKEFILE}\"\r\n")
else()
  file(APPEND ${OPENSSL_MAKE_SCRIPT} "NMake\r\n")
endif()
...
if(OPENSSL_MAJOR_MINOR_VERSION STREQUAL "1.0")
  file(APPEND ${OPENSSL_INSTALL_SCRIPT} "NMake /F \"${OPENSSL_1_0_MAKEFILE}\" install\r\n")
else()
  file(APPEND ${OPENSSL_INSTALL_SCRIPT} "NMake install\r\n")
endif()
file(APPEND ${OPENSSL_INSTALL_SCRIPT}
  ...
  "  COPY /Y tmp32\\lib.pdb \"!SHORTENED_OPENSSL_BINARY_DIR!\"\r\n"
  "  IF NOT %ERRORLEVEL% EQU 0 (\r\n"
  "    ENDLOCAL\r\n"
  "    EXIT /B 1\r\n"
  "  )\r\n"
