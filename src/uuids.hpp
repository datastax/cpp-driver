...
class Uuids {
  public:
    ...
    static inline uint8_t get_version(Uuid uuid) {
  ...
  private:
    ...
    static inline uint64_t from_unix_timestamp(uint64_t timestamp) {
    ...
    static inline void copy_clock_seq_and_node(uint64_t lsb, Uuid uuid) {
