...
SET BOOST_BRANCH_TAG_VERSION=boost-1.57.0
SET LIBUV_REPOSITORY_URL=https://github.com/libuv/libuv.git
SET LIBUV_DIRECTORY=libuv
SET LIBUV_BRANCH_TAG_VERSION=v1.6.1
SET LIBUV_PACKAGE_VERSION=1.6.1
...
SET OPENSSL_BRANCH_TAG_VERSION=OpenSSL_1_0_2d
SET OPENSSL_PACKAGE_VERSION=1.0.2d
