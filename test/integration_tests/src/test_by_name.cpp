...
BOOST_AUTO_TEST_CASE(bind_bytes_by_name)
{
  ...
  BOOST_REQUIRE_EQUAL(cass_statement_bind_uuid_by_name(statement.get(), "key", key), CASS_OK);
  BOOST_REQUIRE_EQUAL(cass_statement_bind_bytes_by_name(statement.get(), "blobs", blob), CASS_OK);
  BOOST_REQUIRE_EQUAL(cass_statement_bind_bytes_by_name(statement.get(), "varints", varint), CASS_OK);
  ...
  BOOST_REQUIRE(value != NULL);
  BOOST_REQUIRE_EQUAL(cass_value_get_bytes(value, &result_blob), CASS_OK);
  ...
  BOOST_REQUIRE(value != NULL);
  BOOST_REQUIRE_EQUAL(cass_value_get_bytes(value, &result_varint), CASS_OK);
