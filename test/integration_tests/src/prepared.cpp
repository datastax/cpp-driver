...
void insert_all_types(CassSession* session, const CassPrepared* prepared, const AllTypes& all_types) {
  test_utils::CassStatementPtr statement = test_utils::make_shared(cass_prepared_bind(prepared, 11, CASS_CONSISTENCY_ONE));
...
BOOST_AUTO_TEST_CASE(test_bound_all_types_null_values)
{
  ...
  test_utils::CassStatementPtr statement = test_utils::make_shared(cass_prepared_bind(prepared.get(), 11, CASS_CONSISTENCY_ONE));
...
void execute_statement(CassSession* session, const CassPrepared* prepared, int value) {
  test_utils::CassStatementPtr statement = test_utils::make_shared(cass_prepared_bind(prepared, 2, CASS_CONSISTENCY_ONE));
