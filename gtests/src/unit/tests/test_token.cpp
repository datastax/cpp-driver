...
TEST(TokenUnitTest, RandomHash)
{
  ...
  EXPECT_EQ(to_string(cass::RandomPartitioner::hash("a")), "16955237001963240173058271559858726497");
  EXPECT_EQ(to_string(cass::RandomPartitioner::hash("b")), "144992942750327304334463589818972416113");
  EXPECT_EQ(to_string(cass::RandomPartitioner::hash("c")), "99079589977253916124855502156832923443");
  EXPECT_EQ(to_string(cass::RandomPartitioner::hash("d")), "166860289390734216023086131251507064403");
  EXPECT_EQ(to_string(cass::RandomPartitioner::hash("abc")), "148866708576779697295343134153845407886");
  EXPECT_EQ(to_string(cass::RandomPartitioner::hash("xyz")), "61893731502141497228477852773302439842");
}

TEST(TokenUnitTest, RandomFromString)
{
  EXPECT_EQ(to_string(cass::RandomPartitioner::from_string("0")), "0");
  EXPECT_EQ(to_string(cass::RandomPartitioner::from_string("1")), "1");
  EXPECT_EQ(to_string(cass::RandomPartitioner::from_string("170141183460469231731687303715884105727")), "170141183460469231731687303715884105727");
  EXPECT_EQ(to_string(cass::RandomPartitioner::from_string("170141183460469231731687303715884105728")), "170141183460469231731687303715884105728");
}
